...
from Detalles D inner join tipos T on D.id_tipo=T.id_tipo inner join municipios M on D.id_municipio=M.id_municipio where D.id_tipo=$var ORDER BY T.nombre_tipo;";
