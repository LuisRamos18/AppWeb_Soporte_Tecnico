        ...
        <div class="container">
          <div class="row">
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url('https://www.ipn.mx/assets/files/dsi/img/servicios/soporte.png'); background-size: cover;">
              </div>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Registro de usuarios</h4>
                  <p class="mb-0">Ingresa tu correo y contraseña para el registro</p>
                </div>
                <div class="card-body">
                  <form role="form">
                    ...
                    <div class="form-check form-check-info text-start ps-0">
                      ...
                      <label class="form-check-label" for="flexCheckDefault">
                        Estoy de acuerdo <a href="javascript:;" class="text-dark font-weight-bolder">con los términos y condiciones</a>
                      </label>
                    </div>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-2 text-sm mx-auto">
                    ...
                    <a href="../GUI/index.php" class="text-primary text-gradient font-weight-bold">Iniciar sesión</a>
                  </p>
                </div>
              </div>
            </div>
